                ...
                <AnimatePresence>
                    {isOpen && (
                        <motion.ul
                            ...
                            onMouseLeave={closeMenu}>
                            <li><Link to="/services/wealth-management">Wealth Analysis</Link></li>
                            <li><Link to="/services/wealth-advisory">Client Portfolio Evaluation</Link></li>
                            <li><Link to="/services/client-portfolio-evaluation">Investment Advisory</Link></li>
                            <li><Link to="/services/client-portfolio-evaluation">Tax Optimization</Link></li>
                            <li><Link to="/services/client-portfolio-evaluation">Wealth Transfer and Inheritance</Link></li>
                        </motion.ul>
                    )}
                </AnimatePresence>
        </div>
